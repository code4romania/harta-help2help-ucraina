    ...
    <x-slot:title>
        ...
        <section class="flex-col">
            <div class="mb-5 flex flex-col justify-between md:flex-row">
                <h2 class="text-xl md:text-2xl lg:text-3xl 2xl:text-4xl">1220 {{ __('txt.service_sm.page_title') }}</h2>
                <div class="flex w-full justify-evenly md:w-1/3">
                    ...
                    <button
                        class="h-12 w-2/5 border-2 text-black hover:bg-blue1 bg-orange1">{{ __('txt.buttons.services_list') }}</button>
                </div>
            </div>
