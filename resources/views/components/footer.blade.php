<footer class="absolute bottom-0 flex h-60 min-h-fit w-full items-center bg-header md:h-72 lg:h-80">
    <div class="container mx-auto flex w-4/5 flex-col md:flex-row md:justify-between">
        <h4 class="mb-0 self-center text-2xl"> {{ __('txt.footer.partners') }}</h4>
        <div class="my-6 flex items-center justify-evenly lg:w-11/12">
